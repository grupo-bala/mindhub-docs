...
- **RF004** - O sistema deve permitir que o usuário avalie comentários. **(Essencial)**
- **RF005** - O sistema deve permitir que o usuário se autentique usando a biometria. **(Desejável)**

#### 3.1.2. Fórum

- **RF006** - O sistema deve permitir que o usuário crie um fórum com uma pergunta. **(Essencial)**
- **RF007** - O sistema deve permitir que o usuário proprietário edite uma pergunta feita. **(Essencial)**
- **RF008** - O sistema deve permitir que o usuário proprietário apague uma pergunta feita. **(Essencial)**
- **RF009** - O sistema deve permitir que usuários vizualizem um fórum criado. **(Essencial)**
- **RF010** - O sistema deve permitir que usuários respondam a um fórum criado. **(Essencial)**
- **RF011** - O sistema deve permitir que o usuário proprietário do fórum marque-o como *resolvido*.
    - **RF011.1** - O sistema deve permitir que o usuário proprietário escolha a melhor resposta. **(Essencial)**
    - **RF011.2** - O sistema deve permitir que o usuário proprietário responda seu fórum, caso encontre a resposta por outros meios. **(Desejável)**
- **RF012** - O sistema deve permitir que usuários avaliem as respostas de um fórum. **(Essencial)**
...
- **RF015** - O sistema deve permitir que o usuário crie um tópico sobre determinado assunto. **(Essencial)**
- **RF016** - O sistema deve permitir que o usuário proprietário edite um tópico feito. **(Essencial)**
- **RF017** - O sistema deve permitir que o usuário proprietário remova um tópico feito. **(Essencial)**
- **RF018** - O sistema deve permitir que usuários comentem em um tópico.
    - **RF018.1** - O sistema deve permitir que o usuário proprietário do comentário o remova. **(Essencial)**
    - **RF018.2** - O sistema deve permitir que o usuário proprietário do comentário o edite. **(Essencial)**
- **RF019** - O sistema deve permitir que usuários avaliem o tópico. **(Essencial)**
- **RF020** - O sistema deve permitir que usários compartilhem postagens. **(Desejável)**

#### 3.1.4. Evento

- **RF021** - O sistema deve permitir que o usário crie um evento. **(Essencial)**
- **RF022** - O sistema deve permitir que o usuário proprietário edite um evento criado. **(Essencial)**
- **RF023** - O sistema deve permitir que o usuário proprietário remova um evento criado. **(Essencial)**
- **RF024** - O sistema deve permitir que o usuário visualize um evento. **(Essencial)**
- **RF025** - O sistema deve permitir que o usuário comente em um evento. **(Essencial)**
- **RF026** - O sistema deve permitir que o usuário responda a um comentário feito em um evento. **(Essencial)**

#### 3.1.5. Feed

- **RF027** - O sistema deve possuir um feed onde exibirá os conteúdos.
    - **RF027.1** - O sistema deve exibir uma lista de postagens baseadas na(s) especialidade(s) do usuário. **(Essencial)**
    - **RF027.2** - O sistema deve exibir uma lista de fóruns baseados na(s) especialidade(s) do usuário. **(Essencial)**
- **RF028** - O sistema deve permitir que o usuário filtre conteúdos por categoria e ou título. **(Essencial)**

#### 3.1.6. Perfil

- **RF029** - O sistema deve exibir as informações do usuário. **(Essencial)**
- **RF030** - O sistema deve exibir as últimas atividades do usário. **(Desejável)**
- **RF031** - O sistema deve permitir que o usuário altere sua informações. **(Essencial)**
- **RF032** - O sistema deve permitir que o usuário remova sua conta. **(Essencial)**

#### 3.1.7. Gameficação
  - **RF033** - O sistema deve conter uma estratégia de gameficação. **(Essencial)**
  - **RF034** - O sistema deve exibir um ranking de usuários. **(Essencial)**
