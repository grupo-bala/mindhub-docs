...
| 05/09/2023 | 0.3          | Adicionado o diagrama de classes inicial do projeto  |
...
![Diagrama de classes do Mindhub](/img/classes.png)

O diagrama acima representa as classes implementadas do sistema e suas relações. Para uma melhor visualização, abra a imagem [aqui](/img/classes.png).